function Rubik(element) {
    ...
    var onCubeMouseUp = function(e, cube) {
        ...
        dragVector.sub(clickVector);
          ...
          //Rotacja tylko w osi, która zawierała najwięcej sześcianów przez które przeszła myszka
    ...
    // Jeśli przy ruchu wyjechano kursorem poza kostkę to trzeba zapamiętać, który sześcian dotknięty był jako ostatni
    ...
    // Obiekt umozliwiajacy obracanie pojedynczych warstw kosci
    ...
    //Wybranie elementów zgodnych z osią obrotu
